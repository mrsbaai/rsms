...
class adminController extends Controller
{
    ...
    public function addtextnow(){
        ...
        $number = number::where('network_login', 'not like', 'aa@%')->where('network', 'textnow')->all()->sortBy('last_checked')->first();
        ...
        $count = number::all()->where('network', 'textnow')->where('network_login', 'not like', 'aa@%')->count();
        ...
        $new_email = $last_names[array_rand($last_names)] . rand(0,999) ."@premiumbooks.net";
            ...
            return view('numbersadmin.addTextnow')->with('email', $email)->with('password', $password)->with('new_email', $new_email)->with('count', $count);
