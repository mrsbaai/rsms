...
class adminController extends Controller
{
    ...
    public function addtextnow(){
        ...
        $count_free = number::where('network', 'textnow')->where('network_login', 'not like', 'aa@%')->where('email', null)->where('last_checked', '<=', Carbon::now()->subDays(3)->toDateTimeString())->count();
