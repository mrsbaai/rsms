...
class contactController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if ($validator->fails()) {
            ...
            return view('contact')->with('result', '- Sent! Please check your e-mail for confirmation. <<IMPORTANT!>> If you don\'t find it in your inbox, please see check SPAM FOLDER, and mark it as Not Spam.');
