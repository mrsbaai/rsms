                        ...
                        <table class="table table-condensed">
                            ...
                            @foreach($rows as $id => $array)
                                <tr>
                                    ...
                                    <td class="lead" style="width: 300px;">{{$array['3']}}<br><br>{{$array['6']}}</td>
                                    <td>
                                        ...
                                        <textarea id="response" type="text" name="response" class="form-control" style="width: 300px; height: 200px;">We have experienced a high volume of inquires and regret that we have not addressed your case sooner.</textarea>
                                        <br/>
