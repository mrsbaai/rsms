            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="form-group" id="final_amount">
						<span>Top-Up Amount:</span><span id="top" style="float:right;font-size:70%;">$0</span><br/>
                        <span style="font-size:70%;">Final Amount:</span><span id="price" style="float:right;">$0</span>
                    </div>
