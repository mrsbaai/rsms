...
Route::get('/admin/mailer/preview/{text1}/{text2}/{text3}/{text4}/{heading1}/{heading2}/{heading3}/{heading4}/{img1}/{img1}/{button1}/{button2}/{button3}/{buttonURL1}/{buttonURL2}/{buttonURL3}', 'adminController@preview');
