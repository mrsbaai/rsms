...
Route::get('/success', function () {
    return view('message')->with('content', 'If you\'ve payed with <b>crypto</b>, your payment will be credited to your balance once it reaches the <b>required confirmations</b>.')->with('titleClass', 'text-success')->with('title', 'Thank you for topping up your account!');
});
